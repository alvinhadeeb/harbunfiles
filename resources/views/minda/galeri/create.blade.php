...
<div class="max-w-2xl">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form action="{{ route('minda.galeri.store') }}" method="POST" enctype="multipart/form-data">
            @csrf

            <div class="mb-5">
                <label class="block text-gray-700 font-semibold mb-2">Foto <span class="text-red-500">*</span></label>
                ...
                <p class="text-xs text-gray-400 mt-1">Maks 5MB. Disarankan rasio 16:9 agar tampil sempurna di carousel.</p>
                @error('gambar')
