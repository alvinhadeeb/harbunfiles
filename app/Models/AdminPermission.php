...
{
    protected $fillable = ['admin_id', 'permission'];
    ...
    public static function availablePermissions(): array
    {
        return [
            'berita' => [
                ...
                'description' => 'Kelola berita: tambah, edit, hapus berita',
            ],
            'kategori' => [
                'label' => 'Kategori',
            ...
            'testimoni' => [
                ...
                'description' => 'Kelola testimoni wali murid',
            ],
            'banner' => [
                'label' => 'Banner',
                ...
                'description' => 'Kelola banner/slider homepage',
            ],
            'galeri' => [
                'label' => 'Galeri',
                'icon' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>',
            ...
            'lembaga' => [
                ...
                'description' => 'Kelola data lembaga/unit',
            ],
            'header' => [
                'label' => 'Menu Header',
                ...
                'description' => 'Kelola menu navigasi header',
            ],
            'faq' => [
                'label' => 'FAQ',
                ...
                'description' => 'Kelola FAQ (Pertanyaan yang Sering Diajukan)',
            ],
            'kontak' => [
                'label' => 'Kontak & Footer',
                ...
                'description' => 'Kelola informasi kontak & footer',
            ],
            'kompres' => [
                'label' => 'Kompres Foto',
                'icon' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>',
                'description' => 'Tools kompres/resize foto',
            ],
        ];
    }
